...
<div class="container-fluid">
	<div class="row">
		<div class="col-sm-10 title">
			<h1><i class="fa fa-bars"></i> Thêm bài viết <a href="{{url('all-posts')}}" class="btn btn-sm btn-default">Về</a></h1>
		</div>
				...
				<form method="post" action="{{url('addpost')}}" enctype="multipart/form-data">
					...
					<div class="col-sm-9">
						<div class="form-group">	
							<input type="text" name="title" id="post-title" class="form-control" placeholder="Tiêu đề">				
						</div>	
						<div class="form-group">	
					...
					<div class="col-sm-3">
						<div class="content publish-box">
							...
							<div class="form-group">
								<button class="btn btn-default" name="status" value="draft">Nháp</button>
							</div>
							<div class="row">
						...
						<div class="content featured-image">
							<h4>Ảnh tiêu đề <span class="pull-right"><i class="fa fa-chevron-down"></i></span></h4><hr>	
							<p><img id="output" style="max-width: 100%;" /></p>	
							<p><input type="file"  accept="image/*" name="image" id="file"  onchange="loadFile(event)" style="display: none;"></p>
							<p><label for="file" style="cursor: pointer;">Đặt ảnh tiêu đề</label></p>
						</div>
					</div>
				</form>
			</div>
